...
type BoardHeaderPropsType = {
  label: string
  fontSize: number
  hideCreate?: boolean
}

function BoardHeader({label, fontSize, hideCreate}: BoardHeaderPropsType) {
  ...
  return (
    <div>
      <div css={categoryTitleWrapperCSS}>
        ...
        {!hideCreate && auth.currentUser.role === "ADMIN" && <Button theme={"grey"} css={buttonCSS} onClick={() => {router.push("/create")}}>Create</Button>}
