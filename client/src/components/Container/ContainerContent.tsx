...
function ContainerContent({customCss, children}: ContainerContentPropsType) {
  return (
    <div css={Array.isArray(customCss) ? [containerContentWrapperCSS, ...customCss] : [containerContentWrapperCSS, customCss]}>
      {children}
    </div>
  )
}
...
function InnerContent({customCss, children}: InnerContentPropsType) {
  return (
    <div  css={Array.isArray(customCss) ? [innerContentWrapperCSS, ...customCss] : [innerContentWrapperCSS, customCss]}>
      {children}
    </div>
  )
}
