...
import com.myapp.api.service.admin.AdminService;
...
public class AdminController {
    ...
    public ResponseEntity<?> createBoard(@Valid @RequestBody CreateBoardDto requestDto, Errors errors, Model model) {
        Map<String, String> validatorResult = adminService.createBoard(requestDto, errors);
    ...
    public ResponseEntity<?> getAllBoards() {
        return new ResponseEntity<>(adminService.getAllBoards(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> changeBoard(@PathVariable("id") long id, @Valid @RequestBody ChangeBoardDto requestDto, Errors errors, Model model) {
        ...
        Map<String, String> validatorResult = adminService.changeBoard(requestDto, id, errors);
    ...
    public ResponseEntity<?> changeBoardsOrders(@Valid @RequestBody ChangeBoardsOrdersDto requestDto) {
        ...
        adminService.changeBoardsOrders(requestDto); // 변경 작업을 boardService로 이동
